...
<form action="<?= URL ?>admin/process/webhosting/deleteDomainReg" method="post" class="needs-validation" novalidate>
    <input type="hidden" name="id" value="<?= $domain->getId() ?>">
    <div class="modal-body">
        <p class="mb-0">
            Biztosan törölni szeretnéd a(z) <strong><?= $domain->getDomain() ?></strong> domaint?
        </p>
    </div>
