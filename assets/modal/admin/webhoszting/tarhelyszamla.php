...
<div class="modal-header">
    <h5 class="modal-title">
        <i class="fa-refresh fa-solid me-2"></i> Tárhely megújítása
    </h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Bezárás"></button>
</div>

<form action="<?= URL ?>admin/process/webhosting/renewSubscription" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
    <div class="modal-body">
        <div class="row g-3">
            <div class="col-12">
                <label for="amount" class="form-label">Összeg</label>
                <div class="input-group">
                    <input type="number" class="form-control" name="amount" id="amount" value="<?= $subs->getPrice() ?>" required min="0">
