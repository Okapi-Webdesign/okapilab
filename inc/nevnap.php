...
class nevnap
{
    public static function refresh()
    {
        ...
        file_put_contents($_SERVER['DOCUMENT_ROOT'] . 'assets/nevnap.json', json_encode($result));
    }

    public static function get(int $month, int $day): array
    {
        $data = json_decode(file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/assets/nevnap.json'), true);
